   ...
   public class UsersDAO
    {
        ...
        {
            String sql = "INSERT into users(nume,username,password,role) values('" + nume + "','" + username + "','" + getMd5Hash(password) +  "','" + role +  "');";
        ...
        {
            String sql = "update users set password ='" + getMd5Hash(newPassword)  + "' WHERE username ='" + username + "';";
